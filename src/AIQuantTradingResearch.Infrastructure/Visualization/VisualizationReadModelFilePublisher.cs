    ...
    public void Publish(VisualizationReadModel model)
    {
        ...
        try
        {
            var payload = new
            {
                ...
                systemHealth = model.SystemHealth is null ? null : new { state = model.SystemHealth.State.ToString().ToLowerInvariant(), provenance = model.SystemHealth.Provenance, reason = model.SystemHealth.Reason },
