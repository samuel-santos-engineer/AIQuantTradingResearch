...
Entry point and navigation for the complete AI Engineering Toolkit
documentation set.
...
## Documentation Set
  ...
  -------------------------------------------------------------------------------------------
                      Sequence Document                                 Primary
                                                                        responsibility
  ---------------------------- ---------------------------------------- ---------------------
                           --- `README.md`                              Documentation entry
                                                                        point and navigation.

                            01 `01-toolkit-overview.md`                 Toolkit purpose,
                                                                        audience, principles,
                                                                        and capabilities.

                            02 `02-getting-started.md`                  Practical first-use
                                                                        workflow.

                            03 `03-toolkit-architecture.md`             Conceptual
                                                                        architecture and
                                                                        relationships among
                                                                        Toolkit assets.

                            04 `04-repository-organization.md`          Physical repository
                                                                        structure and asset
                                                                        placement.

                            05 `05-engineering-workflow.md`             End-to-end
                                                                        engineering
                                                                        lifecycle.

                            06 `06-ai-assisted-engineering.md`          Human and AI
                                                                        collaboration model.

                            07 `07-playbook-usage.md`                   Discovering,
                                                                        selecting, combining,
                                                                        and applying
                                                                        playbooks.

                            08 `08-prompt-usage.md`                     Building and
                                                                        executing
                                                                        high-quality
                                                                        engineering prompts.

                            09 `09-reference-implementation-usage.md`   Safely studying and
                                                                        adapting reference
                                                                        implementations.

                            10 `10-validation-and-quality.md`           Validation, evidence,
                                                                        quality gates, and
                                                                        acceptance.

                            11 `11-governance-and-maintenance.md`       Toolkit evolution,
                                                                        consistency,
                                                                        versioning, and
                                                                        maintenance.

                            12 `12-contribution-guide.md`               Contributing new or
                                                                        changed Toolkit
                                                                        assets.
  -------------------------------------------------------------------------------------------
...
02 Getting Started
  ↓
03 Toolkit Architecture
  ↓
04 Repository Organization
  ↓
05 Engineering Workflow
  ↓
06 AI-Assisted Engineering
  ↓
Task-specific usage documents
```

For an AI coding agent, context should normally be narrower: repository
instructions, the task, applicable standards/playbooks, and only the
reference or documentation pages necessary to execute safely.
...
This area exists to make **documentation purpose** explicit,
...
This area exists to make **audience** explicit, discoverable, and
...
This area exists to make **documentation map** explicit, discoverable,
...
This area exists to make **recommended reading paths** explicit,
discoverable, and repeatable across Toolkit-assisted engineering work.
It should help both human engineers and AI agents understand what
information is authoritative, what actions are expected, and what
evidence is required.
...
This area exists to make **authority and navigation** explicit,
discoverable, and repeatable across Toolkit-assisted engineering work.
It should help both human engineers and AI agents understand what
information is authoritative, what actions are expected, and what
evidence is required.
...
This area exists to make **how to use this documentation** explicit,
discoverable, and repeatable across Toolkit-assisted engineering work.
It should help both human engineers and AI agents understand what
information is authoritative, what actions are expected, and what
evidence is required.
...
This area exists to make **documentation quality** explicit,
discoverable, and repeatable across Toolkit-assisted engineering work.
It should help both human engineers and AI agents understand what
information is authoritative, what actions are expected, and what
evidence is required.
...
This area exists to make **maintenance** explicit, discoverable, and
repeatable across Toolkit-assisted engineering work. It should help both
human engineers and AI agents understand what information is
authoritative, what actions are expected, and what evidence is required.
...
-   Understand the responsibility of **Toolkit Documentation**.
