...
Explains how reference implementations should be inspected, adapted,
validated, and reviewed without confusing examples with authoritative
standards.
...
This area exists to make **purpose of references** explicit,
...
This area exists to make **authority boundary** explicit, discoverable,
...
This area exists to make **selecting a reference** explicit,
discoverable, and repeatable across Toolkit-assisted engineering work.
It should help both human engineers and AI agents understand what
information is authoritative, what actions are expected, and what
evidence is required.
...
This area exists to make **studying a reference** explicit,
discoverable, and repeatable across Toolkit-assisted engineering work.
It should help both human engineers and AI agents understand what
information is authoritative, what actions are expected, and what
evidence is required.
...
This area exists to make **adapting patterns** explicit, discoverable,
and repeatable across Toolkit-assisted engineering work. It should help
both human engineers and AI agents understand what information is
authoritative, what actions are expected, and what evidence is required.
...
This area exists to make **what should not be copied blindly** explicit,
discoverable, and repeatable across Toolkit-assisted engineering work.
It should help both human engineers and AI agents understand what
information is authoritative, what actions are expected, and what
evidence is required.
...
This area exists to make **combining references** explicit,
discoverable, and repeatable across Toolkit-assisted engineering work.
It should help both human engineers and AI agents understand what
information is authoritative, what actions are expected, and what
evidence is required.
...
## Using References with AI Agents

### Purpose

This area exists to make **using references with ai agents** explicit,
discoverable, and repeatable across Toolkit-assisted engineering work.
It should help both human engineers and AI agents understand what
information is authoritative, what actions are expected, and what
evidence is required.
...
This area exists to make **validation expectations** explicit,
discoverable, and repeatable across Toolkit-assisted engineering work.
It should help both human engineers and AI agents understand what
information is authoritative, what actions are expected, and what
evidence is required.
...
This area exists to make **traceability** explicit, discoverable, and
...
This area exists to make **review questions** explicit, discoverable,
and repeatable across Toolkit-assisted engineering work. It should help
both human engineers and AI agents understand what information is
authoritative, what actions are expected, and what evidence is required.
...
This area exists to make **reference evolution** explicit, discoverable,
and repeatable across Toolkit-assisted engineering work. It should help
both human engineers and AI agents understand what information is
authoritative, what actions are expected, and what evidence is required.
...
-   Understand the responsibility of **Reference Implementation Usage**.
